...
export const Nav = ( props: Props ) => {
  ...
  return (
    <nav className="fixed bottom-0 right-1/2 w-full max-w-screen h-fit backdrop-blur bg-primary/80 border-4 border-solid border-secondary-light translate-x-1/2 z-10">
